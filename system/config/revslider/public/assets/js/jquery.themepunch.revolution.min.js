...
! function(jQuery, undefined) {
    ...
    var _ISM = _R.is_mobile(),
        ...
        getScriptLocation = function(a) {
            var b = new RegExp("themepunch.revolution.min.html", "gi"),
                c = "";
            return jQuery("script").each(function() {
                var a = jQuery(this).attr("src");
                a && a.match(b) && (c = a)
            }), c = c.replace("jquery.themepunch.revolution.min.html", ""), c = c.replace("jquery.themepunch.revolution.html", ""), c = c.split("?")[0]
        },
        ...
        abstorel = function(a, b) {
            var c = a.split("http://demo2.ninethemes.net/"),
                d = b.split("http://demo2.ninethemes.net/");
            c.pop();
            for (var e = 0; e < d.length; e++) "." != d[e] && (".." == d[e] ? c.pop() : c.push(d[e]));
            return c.join("http://demo2.ninethemes.net/")
        },
            ...
            a.find("img,.defaultimg, .tp-svg-layer").each(function() {
                ...
                if (c.data("loaded") === undefined && f !== undefined && f.progress && f.progress.match(/loaded/g)) {
                    if (c.attr("src", f.src), "img" == f.type)
                        if (c.hasClass("defaultimg")) _R.isIE(8) ? defimg.attr("src", f.src) : f.src.indexOf("images/transparent.html") == -1 || c.data("bgcolor") === undefined ? c.css({
